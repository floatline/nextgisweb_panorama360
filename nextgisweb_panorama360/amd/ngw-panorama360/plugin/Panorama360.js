define([
    ...
    return declare([_PluginBase], {
        ...
        constructor: function () {
            ...
            if (wmplugin.panoramas.length) {
                settings.panoramas = [];

                array.forEach(wmplugin.panoramas, function (bm, idx){
                    ...
                    if (bm.enabled) {
                        settings.panoramas.push(opts);
                    }
                });

                settings.panoramas.push({
                    "base": {
                        "keyname": "blank",
                    ...
                    "layer": {
                        "title": "None",
                        "visible": settings.panoramas.length ? false : true
                    },
                    source: {}
                });
            }
